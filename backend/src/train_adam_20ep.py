...
SAVE_PATH = "models/best_simple_adam_20ep.pt"  # separate filename - avoids overwriting the original 40-epoch Adam run
...
def main():
    ...
    # Adam with momentum - a classic, simpler optimizer than Adam.
